...
Contact.create(first_name: 'Nancy', last_name: 'Parker', title: 'Chief Medical Officer', department: 'Medical Devices', email: 'nparker@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 1)
Contact.create(first_name: 'Can', last_name: 'Keskin', title: 'Senior Engineer', department: 'Engineering', email: 'ckeskin@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 2)
Contact.create(first_name: 'Diana', last_name: 'Noe', title: 'Staff Accountant', department: 'Accounting Department', email: 'dnoe@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 2)
Contact.create(first_name: 'Steve', last_name: 'Tamaro', title: 'Accounting Manager', department: 'Accounting Department', email: 'stammaro@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 3)
Contact.create(first_name: 'Jim', last_name: 'Speredelozzi', title: 'Senior Director of Global Inside Sales', department: 'Sales Department', email: 'jim@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 3)
Contact.create(first_name: 'Cathy', last_name: 'Counsell', title: 'Executive Director, Gain Share Operational Strategy', department: 'Account Management', email: 'cathy@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'XYZ', organization_id: 4)
Contact.create(first_name: 'Lisa', last_name: 'Candelario', title: 'Supervisor', department: '', email: 'lisa@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'LRM', organization_id: 5)
