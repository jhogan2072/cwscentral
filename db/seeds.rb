...
Van.create(name: 'Van 1', plate_number: '123456', vin: 'ABCDEFGHIJKLMNOP', make: 'CHEVY', model_year: '2012', last_oil_change: '38,000 mi', capcity: 6)
Van.create(name: 'Van 2', plate_number: '234567', vin: 'BCDEFGHIJKLMNOPQ', make: 'FORD', model_year: '2012', last_oil_change: '31,000 mi', capcity: 5)
Van.create(name: 'Van 3', plate_number: '345678', vin: 'CDEFGHIJKLMNOPQR', make: 'FORD', model_year: '2011', last_oil_change: '45,000 mi', capcity: 4)
Van.create(name: 'Van 4', plate_number: '456789', vin: 'DEFGHIJKLMNOPQRS', make: 'FORD', model_year: '2013', last_oil_change: '22,000 mi', capcity: 5)
Van.create(name: 'Van 5', plate_number: '567890', vin: 'EFGHIJKLMNOPQRST', make: 'FORD', model_year: '2012', last_oil_change: '34,000 mi', capcity: 6)
