...
Contact.create(salutation: 'Ms.', first_name: 'Nancy', last_name: 'Parker', title: 'Chief Medical Officer', department: 'Medical Devices', email: 'nparker@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 1)
Contact.create(salutation: 'Mr.', first_name: 'Can', last_name: 'Keskin', title: 'Senior Engineer', department: 'Engineering', email: 'ckeskin@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 2)
Contact.create(salutation: 'Mrs.', first_name: 'Diana', last_name: 'Noe', title: 'Staff Accountant', department: 'Accounting Department', email: 'dnoe@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 2)
Contact.create(salutation: 'Mr.', first_name: 'Steve', last_name: 'Tamaro', title: 'Accounting Manager', department: 'Accounting Department', email: 'stammaro@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 3)
Contact.create(salutation: 'Mr.', first_name: 'Jim', last_name: 'Speredelozzi', title: 'Senior Director of Global Inside Sales', department: 'Sales Department', email: 'jim@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'ABC', organization_id: 3)
Contact.create(salutation: 'Miss', first_name: 'Cathy', last_name: 'Counsell', title: 'Executive Director, Gain Share Operational Strategy', department: 'Account Management', email: 'cathy@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'XYZ', organization_id: 4)
Contact.create(salutation: 'Ms.', first_name: 'Lisa', last_name: 'Candelario', title: 'Supervisor', department: '', email: 'lisa@example.com', mobile: '123-456-7890', fax: '123-456-78890', start_date: '01-jan-2012', sugarcrm_id: 'LRM', organization_id: 5)
...
Placement.create(start_date: '01-sep-2015', paid: false, work_day: 'Thursday', student_gradelevel: 11, earliest_start: '8:00', latest_start: '9:00', ideal_start: '8:30', student_id: 1, contact_id: 1)
Placement.create(start_date: '01-sep-2015', paid: false, work_day: 'Thursday', student_gradelevel: 10, earliest_start: '8:30', latest_start: '9:00', ideal_start: '8:30', student_id: 2, contact_id: 2)
Placement.create(start_date: '01-sep-2015', paid: false, work_day: 'Tuesday', student_gradelevel: 12, earliest_start: '8:30', latest_start: '9:00', ideal_start: '8:30', student_id: 3, contact_id: 3)
Placement.create(start_date: '01-sep-2014', paid: false, work_day: 'Tuesday', student_gradelevel: 9, earliest_start: '8:30', latest_start: '9:00', ideal_start: '8:30', student_id: 4, contact_id: 4)
Placement.create(start_date: '01-sep-2015', end_date: '01-sep-2015', paid: false, work_day: 'Tuesday', student_gradelevel: 10, earliest_start: '8:30', latest_start: '9:00', ideal_start: '8:30', student_id: 4, contact_id: 4)
Placement.create(start_date: '01-sep-2014', paid: true, work_day: 'Monday', student_gradelevel: 10, earliest_start: '8:30', latest_start: '9:00', ideal_start: '8:30', student_id: 5, contact_id: 5)
...
RouteStop.create(stop_order:'A', van_route_id: 1, placement_id: 1)
RouteStop.create(stop_order:'B', van_route_id: 1, placement_id: 3)
RouteStop.create(stop_order:'C', van_route_id: 1, placement_id: 4)
RouteStop.create(stop_order:'D', van_route_id: 1, placement_id: 5)
RouteStop.create(stop_order:'E', van_route_id: 1, placement_id: 7)
