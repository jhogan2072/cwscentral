...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { contact_id: @incident.contact_id, description: @incident.description, incident_date: @incident.incident_date, student_id: @incident.student_id }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { contact_id: @incident.contact_id, description: @incident.description, incident_date: @incident.incident_date, student_id: @incident.student_id }
    assert_redirected_to incident_path(assigns(:incident))
  end
